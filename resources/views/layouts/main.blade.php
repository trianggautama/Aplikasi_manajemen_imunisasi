            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 30px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top" style="max-width: 45px;" src="{{asset('asset_template/images/logo.png')}}" alt="Shards Dashboard">
                  <span class="d-none d-md-inline mt-1">Manajemen Imunisasi</span>
                </div>
              </a>
              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src="{{asset('asset_template/images/avatars/0.jpg')}}" alt="User Avatar">
