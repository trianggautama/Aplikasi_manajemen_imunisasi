                ...
                <div class="card-body">
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group input-group-seamless">
                            ...
                            <input type="text" class="form-control" id="form1-username" placeholder="Nama Pegawai" value="ambil dari pendaftaran"> 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-inline">
                            ...
                            <div class="custom-control custom-radio mb-1">
                                <input type="radio" id="formsRadioChecked" name="formsRadioDefault" class="custom-control-input" >
                    ...
                    <div class="row">
                        <div class="col-md">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="form1-username" placeholder="Kota..." value="ambil dari pendaftaran" > </div>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="form1-username" placeholder="Nama Ibu" value="ambil dari pendaftaran"> </div>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <div class="input-group input-group-seamless">
                            ...
                            <input type="text" class="form-control" id="form1-username" maxlength="14" value="ambil dari pendaftaran"> 
                        </div>
                    </div>
                    <div class="input-group mb-3">
